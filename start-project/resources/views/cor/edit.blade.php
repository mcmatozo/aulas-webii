                        ...
                        <form action="{{ route('color.update', $color->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ $color->name }}" class="form-control" id="color-name" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                                </div>
                            </div>
